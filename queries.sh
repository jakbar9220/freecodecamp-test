...
echo "$($PSQL "SELECT DISTINCT(t.name) from games as g inner JOIN teams as t ON g.winner_id = t.team_id OR g.opponent_id = t.team_id WHERE year = 2014 and round = 'Eighth-Final' order by name")"
